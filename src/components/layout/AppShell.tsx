...
export function AppShell({ children }: AppShellProps) {
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-aurora-radial text-white">
      ...
      <footer className="border-t border-white/8 bg-ink/70 px-4 py-6 backdrop-blur-2xl sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 text-sm text-white/55 sm:flex-row sm:items-center sm:justify-between">
          <p className="leading-6">
            ...
            <a
              href="https://github.com/aviavi16"
              target="_blank"
              rel="noreferrer"
...
function SocialLink({ href, label, icon: Icon }: SocialLinkProps) {
  return (
    <a
      ...
      aria-label={label}
      title={label}
      className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-white/75 transition hover:border-white/20 hover:bg-white/10 hover:text-white"
    >
